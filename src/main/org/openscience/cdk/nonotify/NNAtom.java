 ...
 * @cdk.githash
 */
public class NNAtom extends NNAtomType implements IAtom {
	...
	public Object clone() throws CloneNotSupportedException {
	    ...
	    if (point2d != null) {
	        ((NNAtom)clone).setPoint2d(new Point2d(point2d.x, point2d.y));
	    }
	    if (point3d != null) {
	        ((NNAtom)clone).setPoint3d(new Point3d(point3d.x, point3d.y, point3d.z));
	    }
	    if (fractionalPoint3d != null) {
	        ((NNAtom)clone).setFractionalPoint3d(new Point3d(fractionalPoint3d.x, fractionalPoint3d.y, fractionalPoint3d.z));
	    }
	    return clone;
	}
}
