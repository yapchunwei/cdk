 ...
 * @cdk.githash
 */
public class NNAtomContainer extends NNChemObject implements IAtomContainer {

	private static final long serialVersionUID = 910663082335344975L;

    /**
     * Constructs an empty {@link IAtomContainer}.
     */
    ...
    /**
     * Constructs an empty {@link IAtomContainer} that will contain a certain number of
     * atoms and electronContainers. It will set the starting array lengths to the
     * defined values, but will not create any {@link IAtom} or {@link IElectronContainer}s.
     *
	...
	public NNAtomContainer(int atomCount, int electronContainerCount, int lonePairCount, int singleElectronCount) {
        ...
        lonePairs = new ILonePair[lonePairCount];
        singleElectrons = new ISingleElectron[singleElectronCount];
        atomParities = new Hashtable<IAtom, IAtomParity>(atomCount/2);
	}
