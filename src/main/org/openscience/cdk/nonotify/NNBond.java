 ...
 * @cdk.githash
 */
public class NNBond extends NNElectronContainer implements IBond {
     ...
     */
    public NNBond(IAtom atom1, IAtom atom2, Order order) {
     ...
     */
    public NNBond(IAtom[] atoms, Order order) {
        this.atoms = new IAtom[atoms.length];
        System.arraycopy(atoms, 0, this.atoms, 0, atoms.length);
        atomCount = this.atoms.length;
        this.order = order;
     ...
     */
    public NNBond(IAtom atom1, IAtom atom2, Order order, IBond.Stereo stereo) {
        atoms = new IAtom[2];
        atoms[0] = atom1;
        atoms[1] = atom2;
        this.order = order;
    ...
    public Object clone() throws CloneNotSupportedException {
        NNBond clone = (NNBond) super.clone();
        // clone all the Atoms
        if (atoms != null) {
