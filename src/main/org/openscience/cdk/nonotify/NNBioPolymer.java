 ...
 * @cdk.githash
 */
public class NNBioPolymer extends NNPolymer implements IBioPolymer {
    ...
    public int getMonomerCount() {
        ...
        while(keys.hasNext())   {
            IStrand tmp = strands.get(keys.next());  // Cast exception?!
    ...
    public IMonomer getMonomer(String monName, String strandName) {
        IStrand strand = strands.get(strandName); 
    ...
    public Collection<String> getMonomerNames() {
        ...
        while(keys.hasNext())   {
            IStrand oStrand = strands.get(keys.next());
    ...
    public void removeStrand(String name)   {
        if (strands.containsKey(name))  {
            IStrand strand = strands.get(name);
            this.remove(strand);
            strands.remove(name);
        }
    }
    ...
    public Object clone() throws CloneNotSupportedException {
        NNBioPolymer clone = (NNBioPolymer)super.clone();
        clone.strands.clear();
        for (Iterator<String> strands = clone.getStrandNames().iterator(); strands.hasNext();) {
            IStrand strand = (IStrand)clone.getStrand(strands.next().toString()).clone();
