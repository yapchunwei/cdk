...
public class CDKMCSTest extends CDKTestCase {
    ...
    /**
     * Test of isBondTypeFlag method, of class CDKMCS.
     */
    @Test
    public void testIsBondTypeFlag() {
        System.out.println("isBondTypeFlag");
        BondType bondType = BondType.getInstance();
        //bondType.reset();
        bondType.setBondSensitiveFlag(true);
        boolean expResult = true;
        boolean result = CDKMCS.isBondTypeFlag();
    ...
    public void testGetTimeManager() {
        ...
        TimeManager result = CDKMCS.getTimeManager();
