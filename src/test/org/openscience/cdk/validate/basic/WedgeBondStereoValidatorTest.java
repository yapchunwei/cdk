 ...
 */
public class WedgeBondStereoValidatorTest extends AbstractValidatorTest {

    @BeforeClass
    public static void setup() {
        setValidator(new WedgeBondStereoValidator());
    }

    @Test
    public void testConstructor() {
        IValidator validator = new WedgeBondStereoValidator();
