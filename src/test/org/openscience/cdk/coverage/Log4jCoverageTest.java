/* Copyright (C) 2004-2007,2009  Egon Willighagen <egonw@users.sf.net>
 * 
...
/**
 * TestSuite that tests whether all public methods in the log4j
 * module are tested. Unlike Emma, it does not test that all code is
 * tested, just all methods.
 *
 * @cdk.module test-log4j
 */
public class Log4jCoverageTest extends CoverageAnnotationTest {
