...
/**
 * TestSuite that tests whether all public methods in the ioformats
 * module are tested. Unlike Emma, it does not test that all code is
 * tested, just all methods.
 *
 * @cdk.module test-ioformats
 */
public class IoformatsCoverageTest extends CoverageAnnotationTest {

    private final static String CLASS_LIST = "ioformats.javafiles";
    
    @BeforeClass public static void setUp() throws Exception {
        loadClassList(CLASS_LIST, IoformatsCoverageTest.class.getClassLoader());
    }
